...
def init_fun(args):
    ...
    input_dim = (2*(args.s0+1))**args.num_layers
    ch = args.num_features
    net = model_initialization(args, input_dim=input_dim, ch=ch,s =args.s)

    return net #trainloader, testloader, net
