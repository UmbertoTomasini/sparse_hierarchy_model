    ...
    for s in sss:
        for s0 in s0s:
            ...
            for n in ns:
                ...
                #xx= np.logspace(np.log10(int(200*p_pred)),np.log10(650*p_pred),5)
                for ptrx in xx:
